...
descriptions = {
    Archer       = "HP: 200\nWeapons: Crossbow (high accuracy) & Saber melee backup\nAbilities: Roll evasion, quick Crossbow reload",
    Ninja        = "175 HP, 18 WalkSpeed, Double Jump\nLoadout: Ninja Star + Dash ability. Agile melee/ranged hybrid.",
    Pirate       = "200 HP, Steal Gold +50%\nLoadout: Flintlock & Saber + Powder Bomb ability.",
    Farmer       = "HP: 200\nWeapons: Pitchfork melee & .22 Rifle\nAbilities: Chicken Jockey summon helper\nPassive: +50% auto gold mine production",

    Musketeer    = "HP: 225\nWeapons: Crossbow replaced with high-damage Musket, keeps Saber\nAbilities: Roll reloads Musket (2-bullet mag)",
    Ranger       = "HP: 225\nWeapons: Crossbow does +5 dmg\nAbilities: Faster roll, shooting during roll deals +25% dmg",
    Samurai      = "HP: 225\nWeapons: Gains Katana (70 dmg) and keeps Shurikens\nAbilities: Right-click with Katana to reflect projectiles",
    Shinobi      = "HP: 200\nWeapons: Ninja Stars replaced with Kunai for extra dmg\nAbilities: Dash farther, deals 60 dmg, resets on kill\nPassive: Invisible after standing still 3s (cancels on steal/base entry)",
    Outlaw       = "HP: 225\nWeapons: Flintlock replaced with 6-shot Revolver\nPassive: +30% gold from kill bounties, keeps +50% gold steal",
    Buccaneer    = "HP: 225\nWeapons: Keeps Flintlock/Saber and gains Blunderbuss shotgun for huge dmg\nAbilities: Steals +87.5% more gold, keeps Powder Bomb",
    NiceFarmer   = "HP: 250\nWeapons: Pump Shotgun, Pitchfork\nAbilities: Chicken Jockey\nPassive: +50% auto gold mine production",
    ToxicFarmer  = "HP: 225\nWeapons: Guns replaced with Pesticide Sprayer\nAbilities: Chicken Jockey + constant pesticide cloud (5 dmg/sec)\nPassive: +50% auto gold mine production",

    StealUpgrade = "+10 gold stolen per level (cost scales).",
    AutoMine     = "+2 gold/sec per level (cost scales).",
    EntryTime    = "Reduce base entry time by 0.5s per level.",
    Storage      = "Increase max storage capacity (up to 10,000).",
    KillBounty   = "Increase kill bounty: starts 15 → up to 270 gold.",
}
